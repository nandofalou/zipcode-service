...
final class ViaCepProvider extends AbstractHttpProvider implements ZipcodeProviderInterface
{
    ...
    {
        $data = $this->getJson('https://viacep.com.br/ws/' . $digitsOnly . '/json/');
        ...
        return new NormalizedAddress(
            ...
            stateName: Normalizer::text((string) ($data['estado'] ?? '')),
        );
    }
}
